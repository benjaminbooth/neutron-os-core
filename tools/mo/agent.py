...
Follows the DoctorAgent pattern (tools/agents/doctor/agent.py):
...
from tools.mo.tools import TOOL_DEFS, execute, set_context
from tools.mo.vitals import LeakSignal
