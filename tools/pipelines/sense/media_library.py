...
Usage:
    from tools.pipelines.sense.media_library import MediaLibrary
...
class MediaLibrary:
    ...
    def _get_embedder(self):
        ...
        if self._embedder is None:
            from tools.pipelines.sense.signal_rag import OpenAIEmbeddings, LocalEmbeddings, KeywordEmbeddings
