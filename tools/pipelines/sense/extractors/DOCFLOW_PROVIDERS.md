...
```python
from tools.pipelines.sense.extractors.docflow_providers import ProviderRegistry
...
neut sense providers

# Sync all configured folder providers
neut sense ingest --source docflow

# Sync specific provider
neut sense ingest --source docflow --provider dropbox
```
