...
from tools.pipelines.sense.registry import register_source, SourceType
    ...
    def extract(self, source: Path, **kwargs) -> Extraction:
        ...
        try:
            ...
            if hf_token:
                ...
                try:
                    from tools.pipelines.sense.voice_id import (
                        VoiceProfileStore,
                        SpeakerIdentifier,
                    )
        ...
        try:
            ...
            if speaker_matches:
                try:
                    from tools.pipelines.sense.voice_id import annotate_transcript_with_speakers
