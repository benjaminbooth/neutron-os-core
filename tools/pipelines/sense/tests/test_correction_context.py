...
from tools.pipelines.sense.corrector import TranscriptCorrector, Correction
...
class TestCenteredContextDisplay:
    ...
    def test_centers_on_original_term(self):
        ...
        from tools.pipelines.sense.correction_review import _get_centered_context
...
class TestEndToEndContextFlow:
    ...
    def test_correction_flow_preserves_context(self, tmp_path):
        ...
        from tools.pipelines.sense.correction_review import AppliedCorrection
...
class TestGetAudioTimingForCorrection:
    ...
    def test_timing_function_exists(self):
        ...
        from tools.pipelines.sense.cli import _get_audio_timing_for_correction
