...
Usage:
    ...
    neut sense corrections --guided          # Start guided review
    neut sense corrections --guided --limit 3  # Review up to 3
    neut sense corrections --defer           # Defer all pending to later
    neut sense corrections --cleanup         # Remove processed clips
"""
...
from tools.pipelines.sense.models import DATETIME_FORMAT_COMPACT
...
class GuidedCorrectionReview:
    ...
    def _trigger_learning(
        ...
        try:
            from tools.pipelines.sense.correction_propagation import CorrectionPropagator
