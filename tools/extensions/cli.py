...
def _cmd_list() -> None:
    ...
    from tools.extensions.discovery import discover_extensions
...
def _cmd_docs(args: argparse.Namespace) -> None:
    ...
    from tools.extensions.discovery import generate_contract_docs
...
def _cmd_check(args: argparse.Namespace) -> None:
    ...
    from tools.extensions.contracts import validate_extension
    from tools.extensions.discovery import discover_extensions
