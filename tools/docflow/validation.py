...
try:
    from tools.docflow.state import DocumentState
except ImportError:
...
class DocumentValidator:
    ...
    def _suggest_recovery(self, result: ValidationResult) -> list[str]:
        ...
        if result.publication_status == "draft":
            steps.append("1. Review and finalize markdown in docs/prd/")
            ...
            steps.append("2. Review converted markdown in docs/prd/")
