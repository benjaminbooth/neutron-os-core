...
from tools.docflow.converters.pandoc import PandocConverter, ConversionOptions
...
def main():
    ...
    print("  5. Commit to git: git add docs/prd/ && git commit -m 'docflow: ingest <doc_id>'")
