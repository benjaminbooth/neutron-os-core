...
DOC_MAPPINGS = {
    "reactor-ops-log": "docs/prd/reactor-ops-log-prd.md",
    "ops-log": "docs/prd/reactor-ops-log-prd.md",
    "experiment-manager": "docs/prd/experiment-manager-prd.md",
    "master-prd": "docs/prd/neutron-os-executive-prd.md",
    "executive-prd": "docs/prd/neutron-os-executive-prd.md",
    "neutron-os-executive": "docs/prd/neutron-os-executive-prd.md",
...
def find_md_source(docx_name: str, root: Path) -> Optional[Path]:
    ...
    # Try fuzzy match on docs/prd/ and docs/specs/
    for search_dir in [root / "docs/prd", root / "docs/specs"]:
