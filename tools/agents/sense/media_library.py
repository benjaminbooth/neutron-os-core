...
Usage:
    from tools.agents.sense.media_library import MediaLibrary
...
RAW_VIDEO_DIR = _AGENTS_DIR / "inbox" / "raw" / "video"
...
class MediaItem:
    ...
    This aligns with:
    - [Agent State Management PRD US-021](../docs/prd/agent-state-management-prd.md)
...
class MediaLibrary:
    ...
    def _get_embedder(self):
        ...
        if self._embedder is None:
            from tools.agents.sense.signal_rag import OpenAIEmbeddings, LocalEmbeddings, KeywordEmbeddings
    ...
    def _load_people_registry(self) -> dict[str, dict]:
        ...
        """
        people_path = _AGENTS_DIR.parent / "config" / "people.md"
    ...
    def enrich_rag(self) -> int:
        ...
        """
        from tools.agents.sense.signal_rag import SignalRAG
