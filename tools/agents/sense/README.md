...
python -m tools.agents.sense.cli ingest --source all

# Synthesize into changelog draft
python -m tools.agents.sense.cli draft
```
...
python -m tools.agents.sense.cli serve

# Custom port
python -m tools.agents.sense.cli serve --port 8080
```
...
<dict>
    ...
    <array>
        ...
        <string>-m</string>
        <string>tools.agents.sense.cli</string>
        <string>serve</string>
        <string>--port</string>
        <string>8765</string>
    </array>
