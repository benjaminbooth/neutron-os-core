...
Usage:
    ...
    python -m tools.agents.sense.bootstrap

    # Non-interactive (CI/CD)
    python -m tools.agents.sense.bootstrap --non-interactive

    # Check prerequisites only
    python -m tools.agents.sense.bootstrap --check

    # Specific steps
    python -m tools.agents.sense.bootstrap --step k3d
    python -m tools.agents.sense.bootstrap --step postgres
    python -m tools.agents.sense.bootstrap --step migrate
...
"""
    ...
    def verify_installation(self) -> StepResult:
        ...
        try:
            from tools.agents.sense.migrations import verify_schema
            from tools.agents.sense.db_models import get_engine
