...
class InboxHandler(BaseHTTPRequestHandler):
    ...
    def _serve_feedback_page(self):
        ...
        from tools.agents.sense.feedback import FeedbackCollector, FEEDBACK_TYPES
...
"""
    ...
    def _handle_feedback_submit(self):
        ...
        from tools.agents.sense.feedback import FeedbackCollector, SignalFeedback
...
"""
    ...
    def _serve_feedback_status(self):
        ...
        from tools.agents.sense.feedback import FeedbackCollector
