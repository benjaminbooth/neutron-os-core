...
from tools.repo_sensing.base import RepoActivity, RepoInfo, RepoSourceProvider
...
class TestUtilities:
    def test_truncate(self):
        from tools.repo_sensing.base import truncate
    ...
    def test_parse_datetime(self):
        from tools.repo_sensing.base import parse_datetime
    ...
    def test_is_within_days(self):
        from tools.repo_sensing.base import is_within_days
