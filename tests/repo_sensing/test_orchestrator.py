...
from tools.repo_sensing.base import RepoActivity, RepoInfo
from tools.repo_sensing.config import SourceConfig, detect_sources, load_config
from tools.repo_sensing.orchestrator import (
...
class TestOrchestrator:
    ...
    def test_run_dry_run(self, tmp_path):
        ...
        with patch("tools.repo_sensing.orchestrator._create_provider", return_value=mock_provider):
