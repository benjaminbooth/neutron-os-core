"""Tests for tools.agents.chat.tools_ext.review — conversational review chat tools."""

import pytest
from pathlib import Path

from tools.review.models import ReviewSessionStore
from tools.agents.chat.tools_ext.review import (
    execute,
    _get_store,
    _get_session,
    _set_session,
...
def _reset_module_state():
    ...
    import tools.agents.chat.tools_ext.review as mod
    mod._store = None
