"""Tests for tools.docflow.providers.notification.smtp — SMTP email provider."""

import pytest
from unittest.mock import patch, MagicMock

from tools.docflow.providers.notification.smtp import (
...
class TestSMTPProvider:
    ...
    @patch("tools.docflow.providers.notification.smtp.smtplib.SMTP")
