"""Tests for neutron_os.extensions.builtins.publisher.providers.notification.smtp — SMTP email provider."""

import pytest
from unittest.mock import patch, MagicMock

from neutron_os.extensions.builtins.publisher.providers.notification.smtp import (
...
class TestSMTPProvider:
    ...
    @patch("neutron_os.extensions.builtins.publisher.providers.notification.smtp.smtplib.SMTP")
