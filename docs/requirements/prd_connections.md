...
**Tech Spec:** [Connections & Credentials Spec](../specs/neutron-os-connections-spec.md)
...
- [Connections & Credentials Spec](../specs/neutron-os-connections-spec.md) — Technical specification
- [Security & Access Control PRD](prd_security-access-control.md) — OpenFGA authorization, FR-008
- [Model Routing Spec](../specs/neutron-os-model-routing-spec.md) — LLM provider connections
- [Agent State Management PRD](prd_agent-state-management.md) — Credential state in registry
