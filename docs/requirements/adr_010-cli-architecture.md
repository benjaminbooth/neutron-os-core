...
- [ADR-006: MCP Server + Agentic Access](adr_006-mcp-server-agentic-access.md)
- [neut CLI Spec](../specs/neut-cli-spec.md) — Command structure and extension registration
- [Connections Spec](../specs/neutron-os-connections-spec.md) — `neut connect` command
- [Model Routing Spec](../specs/neutron-os-model-routing-spec.md) — Chat agent routing
