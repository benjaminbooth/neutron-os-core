...
- Connection-level authorization: each connection declares its authorization requirements (see [Connections Spec](../tech-specs/spec-connections.md))
...
- [Connections & Credentials Spec](../tech-specs/spec-connections.md) — Connection abstraction, credential storage, OpenFGA integration plan
- [Connections PRD](prd-connections.md) — User-facing requirements for `neut connect` and credential management
- [Model Routing & Settings Spec](../tech-specs/spec-model-routing.md) — §7 (auth intersection), §8 (prompt injection defense), §10 (EC leakage detection)
- [Agent State Management PRD](prd-agent-state-management.md) — audit trail patterns, PostgreSQL state backend
- [RAG Architecture Spec](../tech-specs/spec-rag-architecture.md) — EC compliance requirements
- [NeutronOS Agents PRD](prd-agents.md) — GOAL_PLT_006–008 (platform security goals)
- [NeutronOS Executive PRD](prd-executive.md)
- [Neut CLI PRD](prd-neut-cli.md) — `neut doctor` and `neut status` extension points
