...
**Brand Reference:** [Brand Identity - CLI Section](../design/spec-brand-identity.md#cli-identity)
...
Full design in `docs/tech-specs/spec-neut-cli.md §Slash Commands`.
...
See [Agent Architecture Spec](../tech-specs/spec-agent-architecture.md) for full design.
...
See [Media Library PRD](prd-media-library.md) for full design.
...
```bash
# Publish a document
neut pub push docs/requirements/prd-foo.md
...
See [Publisher Specification](../tech-specs/spec-publisher.md) for full design.
