...
The CLI design philosophy, slash command dispatch architecture, and cross-extension command reference live in the CLI spec (`docs/specs/neut-cli-spec.md §Slash Commands`). This section covers only the Publisher's contribution to that framework.
...
Neut: 3 documents have unpublished changes:
      ...
      2. docs/specs/routing-spec.md     (spec, never published)
...
docs/specs/routing-spec.md            spec        —         untracked   —
...
docs/specs/routing-spec.md          untracked
...
| Modify `docs/specs/neutron-os-publisher-spec.md §1.3` | Note JSON files are export-only once DB is configured |
...
Neut: You have a technical spec for the digital twin sensor interface
      (docs/specs/dt-sensor-spec.md) — 1,400 words, last updated 3 days ago —
