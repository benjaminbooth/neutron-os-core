...
class TestStrategicOrdering:
    ...
    def test_higher_weight_first(self, tmp_path):
        ...
        from neutron_os.extensions.builtins.sense_agent.correlator import Correlator, Initiative
...
class TestWeeklySummaryAnnotations:
    ...
    def test_blocker_section_in_summary(self, tmp_path):
        ...
        from neutron_os.extensions.builtins.sense_agent.blocker_tracker import BlockerTracker
