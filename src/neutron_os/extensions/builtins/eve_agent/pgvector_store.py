...
Quick Start (local):
    ...
    # Use it
    from neutron_os.extensions.builtins.eve_agent.pgvector_store import VectorDB
    db = VectorDB()
...
def k3d_up() -> bool:
    ...
    print()
    print("To use:")
    print("  from neutron_os.extensions.builtins.eve_agent.pgvector_store import VectorDB")
    print("  db = VectorDB()")
    print()
