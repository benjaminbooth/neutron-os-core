...
def corrector_with_aliases(people_md_with_aliases):
    ...
    from neutron_os.extensions.builtins.eve_agent.corrector import TranscriptCorrector
...
class TestCorrectionResult:
    ...
    def test_correction_result_creation(self):
        ...
        from neutron_os.extensions.builtins.eve_agent.corrector import CorrectionResult
