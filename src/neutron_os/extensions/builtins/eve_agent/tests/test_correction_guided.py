...
class TestGuidedCorrectionReview:
    ...
    def guided_review(self, temp_dirs):
        ...
        with patch.object(
            ...
            import neutron_os.extensions.builtins.eve_agent.correction_review_guided as guided_module
    ...
    def test_extract_audio_clip_no_ffmpeg(self, temp_dirs):
        ...
        with patch("neutron_os.extensions.builtins.eve_agent.correction_review_guided.CLIPS_DIR", temp_dirs["clips_dir"]):
            with patch("neutron_os.extensions.builtins.eve_agent.correction_review_guided.REVIEW_STATE_FILE", temp_dirs["corrections_dir"] / "state.json"):
...
class TestCorrectionPropagation:
    ...
    def propagator(self, temp_propagation_dir):
        ...
        with patch("neutron_os.extensions.builtins.eve_agent.correction_propagation.PROPAGATION_QUEUE", temp_propagation_dir / "queue.json"):
            with patch("neutron_os.extensions.builtins.eve_agent.correction_propagation.PROPAGATION_LOG", temp_propagation_dir / "log.jsonl"):
                with patch("neutron_os.extensions.builtins.eve_agent.correction_propagation.USER_GLOSSARY", temp_propagation_dir / "glossary.json"):
    ...
    def test_propagate_approval_updates_glossary(self, propagator, temp_propagation_dir):
        ...
        with patch("neutron_os.extensions.builtins.eve_agent.correction_propagation.USER_GLOSSARY", glossary_path):
