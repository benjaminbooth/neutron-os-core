...
class TestResolveBaseDir:
    ...
    def test_macos_default(self):
        with patch.dict(os.environ, {}, clear=False):
            ...
            with patch("neutron_os.extensions.builtins.mo_agent.paths.sys") as mock_sys:
...
class TestPublicAPI:
    def test_acquire_and_manager(self, tmp_path):
        import neutron_os.extensions.builtins.mo_agent as mo
        # Reset singleton
        mo._instance = None

        with patch("neutron_os.extensions.builtins.mo_agent.MoManager") as MockMgr:
