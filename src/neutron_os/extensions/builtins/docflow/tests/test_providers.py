"""Contract tests for DocFlow providers.
...
class TestLocalStorageContract:
    ...
    def provider(self, tmp_path):
        from neutron_os.extensions.builtins.docflow.providers.storage.local import LocalStorageProvider
...
class TestTerminalNotificationContract:
    ...
    @pytest.fixture
    def provider(self):
        from neutron_os.extensions.builtins.docflow.providers.notification.terminal import TerminalNotificationProvider
...
class TestDocxFeedbackContract:
    ...
    @pytest.fixture
    def provider(self):
        from neutron_os.extensions.builtins.docflow.providers.feedback.docx_comments import DocxFeedbackProvider
...
class TestPandocDocxContract:
    ...
    @pytest.fixture
    def provider(self):
        from neutron_os.extensions.builtins.docflow.providers.generation.pandoc_docx import PandocDocxProvider
