"""Integration tests for the DocFlow engine.
...
class TestEngineProviderAgnostic:
    ...
    def test_engine_has_no_provider_imports(self):
        ...
        import inspect
        from neutron_os.extensions.builtins.docflow import engine

        source = inspect.getsource(engine)

        # Should NOT import from any specific provider module
        assert "from neutron_os.extensions.builtins.docflow.providers.generation." not in source
        assert "from neutron_os.extensions.builtins.docflow.providers.storage." not in source
        assert "from neutron_os.extensions.builtins.docflow.providers.feedback." not in source
        assert "from neutron_os.extensions.builtins.docflow.providers.notification.terminal" not in source
        assert "from neutron_os.extensions.builtins.docflow.providers.embedding." not in source
    ...
    def test_swapping_storage_provider(self, tmp_path):
        ...
        engine_b = DocFlowEngine(config_b)
