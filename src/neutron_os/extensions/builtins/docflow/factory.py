"""DocFlowFactory — central provider registry with self-registration.

Providers register themselves on import:

    from neutron_os.extensions.builtins.docflow.factory import DocFlowFactory
    DocFlowFactory.register("storage", "local", LocalStorageProvider)

The factory instantiates providers from YAML config:

    provider = DocFlowFactory.create("storage", "local", config_dict)
"""
